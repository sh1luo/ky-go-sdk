...
package KuaiYanGoSdk

import (
	"crypto/rsa"
	"crypto/x509"
	"encoding/pem"
	"github.com/sh1luo/ky-go-sdk/utils"
...
func (k *Api快验_类) S删除绑定信息(响应信息 *string, 账号或卡号, 密码 string) bool {
	请求json := make(map[string]interface{}, 10)
	请求json["Api"] = "DeleteAppUserKey"
	请求json["User"] = 账号或卡号
	请求json["PassWord"] = 密码
...
.参数 响应信息, 文本型, 参考
*/
func (k *Api快验_类) Q取软件用户信息(响应信息 *string) bool {
	请求json := make(map[string]interface{}, 10)
